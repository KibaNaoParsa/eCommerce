<?php
                        if( $transacao -> transacao -> erro ){
                            ...
                            retornada pelo gateway de pagamentos. </p >" .
                            ...
                            " <p> Seu boleto bancário foi gerado corretamente e pode ser acessado
                            no seguinte link . </p>" .
                            anchor ( $transacao -> transacao -> url_acesso ," CLIQUE AQUI PARA IMPRIMIR
                            O BOLETO ",array('target'=>'_blank') ) .
